...
class ConvenioIgeprev:
    ...
    def login(self):
        try:
            ...
            WebDriverWait(self.driver, 15).until(
                EC.presence_of_element_located(IgeprevLocators.CAMPO_USUARIO)
            ).send_keys(self.user)
            WebDriverWait(self.driver, 10).until(
                EC.element_to_be_clickable(IgeprevLocators.BOTAO_CONTINUAR)
            ).click()
            WebDriverWait(self.driver, 10).until(
            ...
            self.driver.find_element(*IgeprevLocators.BOTAO_LOGIN).send_keys(Keys.RETURN)
            
            try:
                WebDriverWait(self.driver, 1.5).until(
                            EC.presence_of_element_located(IgeprevLocators.MENU_PRINCIPAL))
                return True
            ...
            while True:
                try:
                    WebDriverWait(self.driver, 1.5).until(
                        EC.presence_of_element_located(IgeprevLocators.CAMPO_USUARIO)).send_keys(self.user)
                    WebDriverWait(self.driver, 2).until(
                        EC.element_to_be_clickable(IgeprevLocators.BOTAO_CONTINUAR)).click()
                    WebDriverWait(self.driver, 2).until(
                        EC.element_to_be_clickable(IgeprevLocators.CAMPO_SENHA)).send_keys(self.second_password)
                    ZetraCaptchaResolver = input("Resolva o captcha e pressione Enter: ")
                    WebDriverWait(self.driver, 1).until(
                        EC.presence_of_element_located(IgeprevLocators.CAMPO_CAPTCHA)).send_keys(ZetraCaptchaResolver)
                    self.driver.find_element(*IgeprevLocators.CAMPO_CAPTCHA).send_keys(Keys.ENTER)
                    WebDriverWait(self.driver, 1.5).until(
                        EC.presence_of_element_located(IgeprevLocators.MENU_PRINCIPAL))
                    return True
    ...
    def troca_senha(self):
        ...
        try:
            ...
            self.driver.find_element(*IgeprevLocators.BOTAO_VOLTA_TROCA_SENHA).click()
            return True
        except:
    ...
    def confirmacao_leitura(self):
        ...
        time.sleep(0.5)
        try:
            self.driver.find_element(*IgeprevLocators.RADIO_CONFIRMA_LEITURA).click()
            pg.hotkey('pagedown')
            time.sleep(0.5)
            ...
            try:
                try:
                    WebDriverWait(self.driver, 0.5).until(
                        EC.element_to_be_clickable(IgeprevLocators.RADIO_CONFIRMA_LEITURA2)).click()
                except:
                    pass
                ...
                try:
                    try:
                        WebDriverWait(self.driver, 0.5).until(
                            EC.element_to_be_clickable(IgeprevLocators.RADIO_CONFIRMA_LEITURA3)).click()
                        time.sleep(0.1)
                        pg.hotkey('pagedown')
                    except:
                        pass
                    ...
                    try:
                        try:
                            WebDriverWait(self.driver, 0.5).until(
                                EC.element_to_be_clickable(IgeprevLocators.RADIO_CONFIRMA_LEITURA4)).click()
                            time.sleep(0.1)
                        except:
                            pass
                        ...
                        try:
                            try:
                                WebDriverWait(self.driver, 0.5).until(
                                    EC.element_to_be_clickable(IgeprevLocators.RADIO_CONFIRMA_LEITURA5)).click()
                                time.sleep(0.1)
                            except:
                                pass
                            ...
                            try:
                                try:
                                    WebDriverWait(self.driver, 0.5).until(
                                        EC.element_to_be_clickable(IgeprevLocators.RADIO_CONFIRMA_LEITURA6)).click()
                                    time.sleep(0.1)
                                    pg.hotkey('pagedown')
                                except:
                                    pass
                                ...
                                try:
                                    WebDriverWait(self.driver, 1.5).until(
                                        EC.element_to_be_clickable(IgeprevLocators.BOTAO_CONFIRMA_LEITURA)).click()
    ...
    def navegar_menu(self):
        try:
            time.sleep(1)
            WebDriverWait(self.driver, 15).until(
                EC.element_to_be_clickable(IgeprevLocators.MENU_PRINCIPAL)
            ).click()
            WebDriverWait(self.driver, 10).until(
                EC.element_to_be_clickable(IgeprevLocators.MENU_RELATORIOS)
            ).click()
            return True
    ...
    def opcoes_relatorios(self):
        try:
            ...
            #CHECKBOX
            WebDriverWait(self.driver, 10).until(
                EC.element_to_be_clickable(IgeprevLocators.CHECKBOX_DEFERIDA)).click()
            time.sleep(1)
            self.driver.find_element(By.XPATH, "/html/body").send_keys(Keys.PAGE_DOWN)

            WebDriverWait(self.driver, 10).until(
                EC.element_to_be_clickable(IgeprevLocators.SELEC_OPCOES))
            self.driver.find_element(*IgeprevLocators.SELEC_OPCOES).click()
            WebDriverWait(self.driver, 10).until(
                EC.element_to_be_clickable(IgeprevLocators.OPCAO_CSV)
            ).click()
            time.sleep(1)
            WebDriverWait(self.driver, 10).until(
                EC.element_to_be_clickable(IgeprevLocators.BOTAO_GERAR))
            self.driver.find_element(*IgeprevLocators.BOTAO_GERAR).click()    
            WebDriverWait(self.driver, 10).until(
                EC.presence_of_element_located(IgeprevLocators.SENHA_AUTORIZER))
            time.sleep(1)  
            return True
        except Exception as e:
    ...
    def autorizacao_gerador(self):
        try:
            ...
            WebDriverWait(self.driver, 60).until(
                EC.presence_of_element_located(IgeprevLocators.DATA_INICIO))
            return True
        except Exception as e:
    ...
    def download_arquivo(self):
        try:
            ...
            WebDriverWait(self.driver, 10).until(
                EC.element_to_be_clickable(IgeprevLocators.OPCOES_DOWNLOAD)).click()
            WebDriverWait(self.driver, 10).until(
                EC.element_to_be_clickable(IgeprevLocators.BOTAO_DOWNLOAD)).click()
            time.sleep(1)
            return True
