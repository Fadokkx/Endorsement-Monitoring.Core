...
class ProConsigController:
    ...
    def executar_fluxo_completo(self, nome_convenio: str) -> bool:
        ...
        try:
            ...
            try:
                file_manager(pasta_origem=paths.pasta_download, pasta_destino=rf"C:\Relatórios\{data.DATA_PASTA}", parametro_nome= "consignacoes", novo_nome=(f"proconsig_{nome_convenio}_{data.DATA_ARQUIVO}"))
