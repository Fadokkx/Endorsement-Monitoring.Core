from src.processadoras.proconsig.convenios.porto_alegre import ConvenioPortoAlegre
...
class ProConsigController:
    def __init__(self, driver: WebDriver):
        self.driver = driver
        self.convenios: Dict[str, Type] = {
            'porto_alegre': ConvenioPortoAlegre
        }
    ...
    def executar_fluxo_completo(self, nome_convenio: str) -> bool:
        ...
        try:
            ...
            try:
                DM.renomear_e_mover_arquivos(pasta_origem=paths.pasta_download, pasta_destino=rf"C:\Relatórios\{data.DATA_PASTA}", parametro_nome= "consignacoes", novo_nome=(f"proconsig_{nome_convenio}_{data.DATA_ARQUIVO}"))
