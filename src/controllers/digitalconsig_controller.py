...
class DigitalConsigController():
    ...
    def executar_fluxo_completo(self, nome_convenio: str) -> bool:
        ...
        try:
            ...
            try:
                file_manager(pasta_origem=paths.pasta_download, pasta_destino=rf"C:\Relatórios\{data.DATA_PASTA}", parametro_nome= "Relatorio_Consignacao", novo_nome=(f"digitalconsig_{nome_convenio}_{data.DATA_ARQUIVO}"))
