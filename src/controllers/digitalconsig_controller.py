from src.processadoras.digitalconsig.convenios.sorriso import ConvenioSorriso
...
class DigitalConsigController():
    def __init__(self, driver: WebDriver):
        self.driver = driver
        self.convenios: Dict[str, Type] = {
            'sorriso': ConvenioSorriso
        }
    ...
    def executar_fluxo_completo(self, nome_convenio: str) -> bool:
        ...
        try:
            ...
            try:
                DM.renomear_e_mover_arquivos(pasta_origem=paths.pasta_download, pasta_destino=rf"C:\Relatórios\{data.DATA_PASTA}", parametro_nome= "Relatorio_Consignacao", novo_nome=(f"digitalconsig_{nome_convenio}_{data.DATA_ARQUIVO}"))
