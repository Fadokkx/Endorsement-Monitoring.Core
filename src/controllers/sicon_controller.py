from src.processadoras.sicon.convenios.pref_santo_andre import ConvenioPrefSantoAndre
...
class SiConsigController():
    def __init__(self, driver: WebDriver):
        ...
        'pref_santo_andre': ConvenioPrefSantoAndre
        }
    ...
    def executar_fluxo_completo(self, nome_convenio: str) -> bool:
        ...
        try:
            ...
            try:
                DM.renomear_e_mover_arquivos(pasta_origem=paths.pasta_download, pasta_destino=rf"C:\Relatórios\{data.DATA_PASTA}", parametro_nome= "CUSTOMIZAVELDEAVERBACAO", novo_nome=(f"sicon_{nome_convenio}_{data.DATA_ARQUIVO}"))
