...
class SiConsigController():
    ...
    def executar_fluxo_completo(self, nome_convenio: str) -> bool:
        ...
        try:
            ...
            try:
                file_manager(pasta_origem=paths.pasta_download, pasta_destino=rf"C:\Relatórios\{data.DATA_PASTA}", parametro_nome= "CUSTOMIZAVELDEAVERBACAO", novo_nome=(f"sicon_{nome_convenio}_{data.DATA_ARQUIVO}"))
