...
def main():
    ...
    try:
        ...
        convenios = ['nova_lima','curitiba','sobral','embu', 'hortolandia', 'hospital_do_servidor_publico', 'igeprev', 'sbc', 'serra', 'uberlandia']  # Ou None para todos
    ...
    try:
        ...
        convenios = ['govsp', 'govmt', 'govsefazsp', 'serra', 'uberlandia']  # Ou None para todos
